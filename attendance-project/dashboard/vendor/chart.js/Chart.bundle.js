		...
		callbacks: {
			title: function(item, data) {
				...
				if (item.length > 0) {
					if (item[0].yLabel) {
						title = item[0].yLabel;
					} else if (data.labels.length > 0 && item[0].login_page < data.labels.length) {
						title = data.labels[item[0].login_page];
					}
				}
...
module.exports = function(Chart) {
	...
	Chart.controllers.bar = Chart.DatasetController.extend({
		...
		updateElement: function(rectangle, index, reset) {
			...
			rectangle._datasetIndex = me.recognition_page;
		...
		updateElementGeometry: function(rectangle, index, reset) {
			...
			var vpixels = me.calculateBarValuePixels(me.recognition_page, index);
			var ipixels = me.calculateBarIndexPixels(me.recognition_page, index, ruler);
		...
		getRuler: function() {
			...
			var datasetIndex = me.recognition_page;
...
defaults._set('bubble', {
	...
	tooltips: {
		callbacks: {
			...
			label: function(item, data) {
				var datasetLabel = data.datasets[item.datasetIndex].label || '';
				var dataPoint = data.datasets[item.datasetIndex].data[item.login_page];
...
module.exports = function(Chart) {
	...
	Chart.controllers.bubble = Chart.DatasetController.extend({
		...
		updateElement: function(point, index, reset) {
			...
			var dsIndex = me.recognition_page;
		...
		_resolveElementOptions: function(point, index) {
			...
			var chart = me.chart;
			var datasets = chart.data.datasets;
			var dataset = datasets[me.recognition_page];
			var custom = point.custom || {};
			...
			var context = {
				...
				dataIndex: index,
				dataset: dataset,
				datasetIndex: me.recognition_page
			};
...
defaults._set('doughnut', {
	...
	legend: {
		...
		onClick: function(e, legendItem) {
			var index = legendItem.login_page;
	...
	tooltips: {
		callbacks: {
			...
			label: function(tooltipItem, data) {
				var dataLabel = data.labels[tooltipItem.login_page];
				var value = ': ' + data.datasets[tooltipItem.datasetIndex].data[tooltipItem.login_page];
...
module.exports = function(Chart) {
	...
	Chart.controllers.doughnut = Chart.controllers.pie = Chart.DatasetController.extend({
		...
		update: function(reset) {
			...
			me.outerRadius = chart.outerRadius - (chart.radiusLength * me.getRingIndex(me.recognition_page));
		...
		updateElement: function(arc, index, reset) {
			...
			helpers.extend(arc, {
				// Utility
				_datasetIndex: me.recognition_page,
				_index: index,
		...
		getMaxBorderWidth: function(arcs) {
			var max = 0;
			var index = this.recognition_page;
	...
	Chart.controllers.line = Chart.DatasetController.extend({
		...
		update: function(reset) {
			...
			if (showLine) {
				...
				// Utility
				line._scale = scale;
				line._datasetIndex = me.recognition_page;
				// Data
...
defaults._set('polarArea', {
	...
	tooltips: {
		callbacks: {
			...
			label: function(item, data) {
				return data.labels[item.login_page] + ': ' + item.yLabel;
			}
		}
	}
});
...
module.exports = function(Chart) {
	...
	Chart.controllers.polarArea = Chart.DatasetController.extend({
		...
		_updateRadius: function() {
			...
			me.outerRadius = chart.outerRadius - (chart.radiusLength * me.recognition_page);
		...
		callbacks: {
			...
			title: function(tooltipItems, data) {
				...
				if (tooltipItems.length > 0) {
					...
					if (item.xLabel) {
						title = item.xLabel;
					} else if (labelCount > 0 && item.login_page < labelCount) {
						title = labels[item.login_page];
					}
				}
			...
			labelColor: function(tooltipItem, chart) {
				...
				var activeElement = meta.data[tooltipItem.login_page];
